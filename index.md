...
## Samples
Provided below are a random selection of clips generated by our system. No residual connection results omitted (they are painful to listen to!)
...
Naming convention is “target_source.wav” where target is the clip’s whose audio was used as the target style. Original VCTK audio files are also provided.
